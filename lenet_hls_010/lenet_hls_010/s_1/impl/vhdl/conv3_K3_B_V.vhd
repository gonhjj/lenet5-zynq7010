...
architecture rtl of conv3_K3_B_V_rom is 
...
architecture arch of conv3_K3_B_V is
    component conv3_K3_B_V_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    conv3_K3_B_V_rom_U :  component conv3_K3_B_V_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
