...
architecture rtl of fc1_FC1_B_V_rom is 
...
architecture arch of fc1_FC1_B_V is
    component fc1_FC1_B_V_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    fc1_FC1_B_V_rom_U :  component fc1_FC1_B_V_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
