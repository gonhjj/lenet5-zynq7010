...
// ==============================================================
#ifndef __lenet_mac_muladd_eOg__HH__
#define __lenet_mac_muladd_eOg__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(lenet_mac_muladd_eOg) {
    ...
    SC_CTOR(lenet_mac_muladd_eOg):  simcore_mac_2_U ("simcore_mac_2_U") {
