...
// ==============================================================
#ifndef __lenet_mac_muladd_g8j__HH__
#define __lenet_mac_muladd_g8j__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(lenet_mac_muladd_g8j) {
    ...
    SC_CTOR(lenet_mac_muladd_g8j):  simcore_mac_4_U ("simcore_mac_4_U") {
