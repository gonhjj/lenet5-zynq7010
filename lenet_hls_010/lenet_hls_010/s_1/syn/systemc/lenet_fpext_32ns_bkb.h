...
// ==============================================================
#ifndef __lenet_fpext_32ns_bkb__HH__
#define __lenet_fpext_32ns_bkb__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(lenet_fpext_32ns_bkb) {
    ...
    SC_CTOR(lenet_fpext_32ns_bkb):  ACMP_fpext_U ("ACMP_fpext_U") {
