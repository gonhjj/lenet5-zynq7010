...
// ==============================================================
#ifndef __lenet_mac_muladd_dEe__HH__
#define __lenet_mac_muladd_dEe__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(lenet_mac_muladd_dEe) {
    ...
    SC_CTOR(lenet_mac_muladd_dEe):  simcore_mac_1_U ("simcore_mac_1_U") {
