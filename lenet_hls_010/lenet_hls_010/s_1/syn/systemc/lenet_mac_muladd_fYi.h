...
// ==============================================================
#ifndef __lenet_mac_muladd_fYi__HH__
#define __lenet_mac_muladd_fYi__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(lenet_mac_muladd_fYi) {
    ...
    SC_CTOR(lenet_mac_muladd_fYi):  simcore_mac_3_U ("simcore_mac_3_U") {
