...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename FC2_out_V \
    op interface \
    ports { FC2_out_V_address0 { O 4 vector } FC2_out_V_ce0 { O 1 bit } FC2_out_V_q0 { I 16 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'FC2_out_V'"
}
}
