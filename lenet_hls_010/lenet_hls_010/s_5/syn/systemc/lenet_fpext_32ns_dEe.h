...
// ==============================================================
#ifndef __lenet_fpext_32ns_dEe__HH__
#define __lenet_fpext_32ns_dEe__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(lenet_fpext_32ns_dEe) {
    ...
    SC_CTOR(lenet_fpext_32ns_dEe):  ACMP_fpext_U ("ACMP_fpext_U") {
