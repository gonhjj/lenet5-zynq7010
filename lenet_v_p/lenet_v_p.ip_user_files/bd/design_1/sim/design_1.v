...
(* CORE_GENERATION_INFO = "design_1,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=design_1,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=8,numReposBlks=8,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=1,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_clkrst_cnt=4,da_ps7_cnt=1,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "design_1.hwdef" *) 
module design_1
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
  ...
  wire [31:0]lenet_0_Cout_PORTA_ADDR;
  wire lenet_0_Cout_PORTA_CLK;
  wire [31:0]lenet_0_Cout_PORTA_DIN;
  wire [31:0]lenet_0_Cout_PORTA_DOUT;
  wire lenet_0_Cout_PORTA_EN;
  wire lenet_0_Cout_PORTA_RST;
  wire [3:0]lenet_0_Cout_PORTA_WE;
  wire [31:0]lenet_0_input_r_PORTA_ADDR;
  wire lenet_0_input_r_PORTA_CLK;
  wire [31:0]lenet_0_input_r_PORTA_DIN;
  wire [31:0]lenet_0_input_r_PORTA_DOUT;
  wire lenet_0_input_r_PORTA_EN;
  wire lenet_0_input_r_PORTA_RST;
  wire [3:0]lenet_0_input_r_PORTA_WE;
  ...
  design_1_blk_mem_gen_0_1 blk_mem_gen_1
       (.addra(lenet_0_Cout_PORTA_ADDR),
        ...
        .clka(lenet_0_Cout_PORTA_CLK),
        .clkb(axi_bram_ctrl_1_BRAM_PORTA_CLK),
        .dina(lenet_0_Cout_PORTA_DIN),
        .dinb(axi_bram_ctrl_1_BRAM_PORTA_DIN),
        .douta(lenet_0_Cout_PORTA_DOUT),
        .doutb(axi_bram_ctrl_1_BRAM_PORTA_DOUT),
        .ena(lenet_0_Cout_PORTA_EN),
        .enb(axi_bram_ctrl_1_BRAM_PORTA_EN),
        .rsta(lenet_0_Cout_PORTA_RST),
        .rstb(axi_bram_ctrl_1_BRAM_PORTA_RST),
        .wea(lenet_0_Cout_PORTA_WE),
        .web(axi_bram_ctrl_1_BRAM_PORTA_WE));
  design_1_lenet_0_3 lenet_0
       (.Cout_Addr_A(lenet_0_Cout_PORTA_ADDR),
        .Cout_Clk_A(lenet_0_Cout_PORTA_CLK),
        .Cout_Din_A(lenet_0_Cout_PORTA_DIN),
        .Cout_Dout_A(lenet_0_Cout_PORTA_DOUT),
        .Cout_EN_A(lenet_0_Cout_PORTA_EN),
        .Cout_Rst_A(lenet_0_Cout_PORTA_RST),
        .Cout_WEN_A(lenet_0_Cout_PORTA_WE),
        .ap_clk(processing_system7_0_FCLK_CLK0),
        .ap_rst_n(proc_sys_reset_0_peripheral_aresetn),
        .input_r_Addr_A(lenet_0_input_r_PORTA_ADDR),
        .input_r_Clk_A(lenet_0_input_r_PORTA_CLK),
        .input_r_Din_A(lenet_0_input_r_PORTA_DIN),
        .input_r_Dout_A(lenet_0_input_r_PORTA_DOUT),
        .input_r_EN_A(lenet_0_input_r_PORTA_EN),
        .input_r_Rst_A(lenet_0_input_r_PORTA_RST),
        .input_r_WEN_A(lenet_0_input_r_PORTA_WE),
        .s_axi_Crtl_ARADDR(smartconnect_0_M02_AXI_ARADDR),
        .s_axi_Crtl_ARREADY(smartconnect_0_M02_AXI_ARREADY),
        .s_axi_Crtl_ARVALID(smartconnect_0_M02_AXI_ARVALID),
        .s_axi_Crtl_AWADDR(smartconnect_0_M02_AXI_AWADDR),
        .s_axi_Crtl_AWREADY(smartconnect_0_M02_AXI_AWREADY),
        .s_axi_Crtl_AWVALID(smartconnect_0_M02_AXI_AWVALID),
        .s_axi_Crtl_BREADY(smartconnect_0_M02_AXI_BREADY),
        .s_axi_Crtl_BRESP(smartconnect_0_M02_AXI_BRESP),
        .s_axi_Crtl_BVALID(smartconnect_0_M02_AXI_BVALID),
        .s_axi_Crtl_RDATA(smartconnect_0_M02_AXI_RDATA),
        .s_axi_Crtl_RREADY(smartconnect_0_M02_AXI_RREADY),
        .s_axi_Crtl_RRESP(smartconnect_0_M02_AXI_RRESP),
        .s_axi_Crtl_RVALID(smartconnect_0_M02_AXI_RVALID),
        .s_axi_Crtl_WDATA(smartconnect_0_M02_AXI_WDATA),
        .s_axi_Crtl_WREADY(smartconnect_0_M02_AXI_WREADY),
        .s_axi_Crtl_WSTRB(smartconnect_0_M02_AXI_WSTRB),
        .s_axi_Crtl_WVALID(smartconnect_0_M02_AXI_WVALID));
